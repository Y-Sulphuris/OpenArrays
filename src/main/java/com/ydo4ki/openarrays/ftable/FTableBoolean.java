...
public interface FTableBoolean<O> {
    ...
    static <O> FTableBoolean<O> newTable(MethodHandles.Lookup lookup, Class<O> owner, String fieldNamesBase, int length) throws FieldTableFormingException {
    ...
    static <O> FTableBoolean<O> newTable(MethodHandles.Lookup lookup, Class<O> owner, String... fieldNames) throws FieldTableFormingException {
