...
public class Array112<T> extends Array104<T> {
	...
	private static final FTable ftable = FTable.fast(MethodHandles.lookup(), Array112.class, Object.class, "e", 112);
}
