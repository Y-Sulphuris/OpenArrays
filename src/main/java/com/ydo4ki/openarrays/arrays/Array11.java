...
public class Array11<T> extends OpenArray<T> {
	public T e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10;
	...
	private static final FTable ftable = FTable.fast(MethodHandles.lookup(), Array11.class, Object.class, "e", 11);
}
