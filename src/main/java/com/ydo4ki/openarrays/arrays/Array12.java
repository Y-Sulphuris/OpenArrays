...
public class Array12<T> extends OpenArray<T> {
	public T e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11;
	...
	private static final FTable ftable = FTable.fast(MethodHandles.lookup(), Array12.class, Object.class, "e", 12);
}
