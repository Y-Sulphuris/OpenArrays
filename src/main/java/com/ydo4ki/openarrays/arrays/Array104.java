...
public class Array104<T> extends Array96<T> {
	...
	private static final FTable ftable = FTable.fast(MethodHandles.lookup(), Array104.class, Object.class, "e", 104);
}
